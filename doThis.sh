...
./scripts/convertRootToJson.py \
  --inputFile ${SKNANO_DATA}/${ERA}/MUO/efficiency_TopHNT.root \
...
./scripts/convertRootToJson.py \
  --inputFile ${SKNANO_DATA}/${ERA}/MUO/efficiency_Mu23El12_Mu23Leg.root \
...
./scripts/convertRootToJson.py \
  --inputFile ${SKNANO_DATA}/${ERA}/EGM/efficiency_TopHNT.root \
  --inputHist data:sim:sf --outputName eff_data:eff_mc:sf \
  --csetName "Measured efficiency for TopHNT ID" \
...
./scripts/convertRootToJson.py \
  --inputFile ${SKNANO_DATA}/${ERA}/EGM/efficiency_Mu8El23_El23Leg.root \
  --inputHist Mu8El23_Data:Mu8El23_MC --outputName eff_data:eff_mc \
...
./scripts/convertRootToJson.py \
  --inputFile ${SKNANO_DATA}/${ERA}/EGM/efficiency_Mu23El12_El12Leg.root \
  --inputHist Mu23El12_Data:Mu23El12_MC --outputName eff_data:eff_mc \
  --xaxis abssceta --yaxis pt \

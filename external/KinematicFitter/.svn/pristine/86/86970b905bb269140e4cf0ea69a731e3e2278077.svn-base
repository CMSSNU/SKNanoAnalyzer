...
// Constructor --
//----------------
TFitParticleEtPhi::TFitParticleEtPhi()
  :TAbsFitParticle()  
{
  init(0, 0);
}

TFitParticleEtPhi::TFitParticleEtPhi( const TFitParticleEtPhi& fitParticle )
...
TFitParticleEtPhi::TFitParticleEtPhi(TLorentzVector* pini, const TMatrixD* theCovMatrix)
  :TAbsFitParticle()  
{
  init(pini, theCovMatrix);
}

TFitParticleEtPhi::TFitParticleEtPhi(const TString &name, const TString &title, 
...
TAbsFitParticle* TFitParticleEtPhi::clone( const TString& newname ) const {
  // Returns a copy of itself
  
  TAbsFitParticle* myclone = new TFitParticleEtPhi( *this );
...
// Operations --
//--------------
void TFitParticleEtPhi::init(TLorentzVector* pini, const TMatrixD* theCovMatrix ) {
...
TLorentzVector* TFitParticleEtPhi::calc4Vec( const TMatrixD* params ) {
...
void TFitParticleEtPhi::setIni4Vec(const TLorentzVector* pini) {
...
TMatrixD* TFitParticleEtPhi::getDerivative() {
  ...
  (*DerivativeMatrix)(3,0) = TMath::CosH(eta);
   ...
   //3rd column: dP/d(phi)
  (*DerivativeMatrix)(0,1) = -1.*et*TMath::Sin(phi);
  (*DerivativeMatrix)(1,1) = et*TMath::Cos(phi);
...
TMatrixD* TFitParticleEtPhi::transform(const TLorentzVector& vec) {

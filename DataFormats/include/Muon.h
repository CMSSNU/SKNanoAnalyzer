...
public:
    ...
    void SetIDBit(BooleanID id, bool value);
    ...
    // Unsigned char IDs
    enum class WorkingPointID {NONE, HIGHPT, MINIISO, MULTIISO, MVA, MVALOWPT, PFISO, PUPPIISO, TRKISO};
    enum class WorkingPoint {None, VLOOSE, LOOSE, MEDIUM, TIGHT, VTIGHT, VVTIGHT};

    void SetIDBit(WorkingPointID id, unsigned char value);
    ...
    inline WorkingPoint TrkIsoId() const {return (WorkingPoint)j_trkIsoId;}
...
private:
    ...
    unsigned char j_highPtId, j_miniIsoId, j_multiIsoId, j_mvaId, j_mvaLowPtId, j_pfIsoId, j_puppiIsoId, j_trkIsoId;
